...
def edit_infer(
    ...
    return generated_wave.squeeze(0).cpu().numpy(), target_sample_rate, gen_mel_spec[0].cpu().numpy()
if __name__ == "__main__":
    ...
    generated_wave,target_sample_rate, gen_mel_spec = edit_infer(audio_to_edit, target_text, parts_to_edit, fix_duration, model, vocoder)

    save_spectrogram(gen_mel_spec, f"{output_dir}/speech_edit_out.png")
