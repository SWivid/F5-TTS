...
def lens_to_mask(t: int["b"], length: int | None = None) -> bool["b n"]:  # noqa F722
...
def mask_from_start_end_indices(seq_len: int["b"], start: int["b"], end: int["b"]):  # noqa F722
...
def mask_from_frac_lengths(seq_len: int["b"], frac_lengths: float["b"]):  # noqa F722
