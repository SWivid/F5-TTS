...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to custom tokenizer (required if tokenizer is 'custom')",
    )
...
def main():
    ...
    # Determine tokenizer path based on arguments
    if args.tokenizer == "custom":
        if not args.tokenizer_path:
            raise ValueError("tokenizer_path must be provided when using a custom tokenizer")
